...
namespace AcspNet.ModelBinding.Binders.Parsers
{
	...
	public class StringToSpecifiedObjectParser
	{
		...
		public static object ParseUndefined(string value, Type parsingType, string format = null)
		{
			...
			throw new ModelBindingException(string.Format("String parsing failed, not supported type: '{0}', value '{1}'", parsingType, value));
		}
		...
		public static bool ParseBool(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to bool parsing failed, value: '{0}'", value));
		}
		...
		public static bool? ParseNullableBool(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to nullable bool parsing failed, value: '{0}'", value));
		}
		...
		public static int ParseInt(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to int parsing failed, value: '{0}'", value));
		}
		...
		public static int? ParseNullableInt(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to nullable int parsing failed, value: '{0}'", value));
		}
		...
		public static decimal ParseDecimal(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to decimal parsing failed, value: '{0}'", value));
		}
		...
		public static decimal? ParseNullableDecimal(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to nullable decimal parsing failed, value: '{0}'", value));
		}
		...
		public static long ParseLong(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to long parsing failed, value: '{0}'", value));
		}
		...
		public static long? ParseNullableLong(string value)
		{
			...
			throw new ModelBindingException(string.Format("String to nullable long parsing failed, value: '{0}'", value));
		}
		...
		public static DateTime ParseDateTime(string value, string format = null)
		{
			...
			if (format != null)
			{
				...
				throw new ModelBindingException(string.Format("String to DateTime parsing failed, required format is '{0}', value: '{1}'", format, value));
			}

			if (DateTime.TryParse(value, out buffer))
				return buffer;

			throw new ModelBindingException(string.Format("String to DateTime parsing failed, value: '{0}'", value));
		}
		...
		public static DateTime? ParseNullableDateTime(string value, string format = null)
		{
			...
			if (format != null)
			{
				...
				throw new ModelBindingException(string.Format("String to nullable DateTime parsing failed, required format is '{0}', value: '{1}'", format, value));
			}

			if (DateTime.TryParse(value, out buffer))
				return buffer;

			throw new ModelBindingException(string.Format("String to nullable DateTime parsing failed, value: '{0}'", value));
		}
