...
namespace AcspNet.Tests.Core
{
	...
	public class RequestHandlerTests
	{
		...
		public void ProcessRequest_Ok_PageBuiltWithOutput()
		{
			...
			_controllersHandler.Setup(x => x.ProcessRequest(It.IsAny<IDIContainerProvider>(), It.IsAny<IOwinContext>())).Returns(ControllersHandlerResult.Ok);
		...
		{
			// Assign
			_controllersHandler.Setup(x => x.ProcessRequest(It.IsAny<IDIContainerProvider>(), It.IsAny<IOwinContext>())).Returns(ControllersHandlerResult.RawOutput);
		...
		{
			// Assign
			_controllersHandler.Setup(x => x.ProcessRequest(It.IsAny<IDIContainerProvider>(), It.IsAny<IOwinContext>())).Returns(ControllersHandlerResult.Http401);
		...
		{
			// Assign
			_controllersHandler.Setup(x => x.ProcessRequest(It.IsAny<IDIContainerProvider>(), It.IsAny<IOwinContext>())).Returns(ControllersHandlerResult.Http403);
		...
		{
			// Assign
			_controllersHandler.Setup(x => x.ProcessRequest(It.IsAny<IDIContainerProvider>(), It.IsAny<IOwinContext>())).Returns(ControllersHandlerResult.Http404);
