...
namespace AcspNet.Tests.Core
{
	...
	private Mock<IControllerFactory> _factory;
		...
		public void Initialize()
		{
			...
			_factory.Setup(x => x.CreateController(It.IsAny<IDIContainerProvider>(), It.IsAny<Type>(), It.IsAny<IOwinContext>())).Returns(_controller.Object);
		}
		...
		public void CreateAndInvokeControllers_ControllerMatched_InvokedCorrectly()
		{
			...
			_factory.Verify(x => x.CreateController(It.IsAny<IDIContainerProvider>(), It.Is<Type>(t => t == typeof(TestController1)), It.IsAny<IOwinContext>()), Times.Exactly(1));
		...
		public void CreateAndInvokeControllers_NoControllersMatchedNo404Controller_404Returned()
		{
			...
			_factory.Verify(x => x.CreateController(It.IsAny<IDIContainerProvider>(), It.Is<Type>(t => t == typeof(TestController1)), It.IsAny<IOwinContext>()), Times.Never);
		}
		...
		public void CreateAndInvokeControllers_NoControllersMatchedButHave404Controller_404ControllerExecuted()
		{
			...
			_factory.Verify(x => x.CreateController(It.IsAny<IDIContainerProvider>(), It.Is<Type>(t => t == typeof(TestController2)), It.IsAny<IOwinContext>()));
		}
	}
}