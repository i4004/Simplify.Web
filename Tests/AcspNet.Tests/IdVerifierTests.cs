...
namespace AcspNet.Tests
{
	...
	public class IdVerifierTests
	{
		...
		public void VeiryQueryStringID_NullID_MessageBoxDisplayed()
		{
			...
			var verifier = new IdVerifier(queryString, null, mb.Object, null);
		...
		public void CheckAndGetFormID_NullID_MessageBoxDisplayed()
		{
			...
			var verifier = new IdVerifier(null, form, mb.Object, null);
		...
		public void VerifyQueryStringIdAjax_NullID_MessageBoxDisplayed()
		{
			...
			var verifier = new IdVerifier(queryString, null, mb.Object, displayer.Object);
			...
			displayer.Verify(x => x.DisplayNoCache(It.Is<string>(c => c == "FooData")), Times.Once);
		}
		...
		public void VerifyQueryStringIdAjax_ValidID_MessageBoxDisplayed()
		{
			...
			displayer.Verify(x => x.DisplayNoCache(It.IsAny<string>()), Times.Never);
		}
	}
}