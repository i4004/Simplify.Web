...
{
	[TestFixture]
	public class ExtensionsDataLoaderTests
	{
		[TestFixtureSetUp]
		public void SetUpFileSystem()
		{
			...
			files.Add("ExtensionsData/Foo.en.xml", "Dummy data");
			files.Add("ExtensionsData/Foo.en", "Dummy data");
			files.Add("ExtensionsData/FooX.en.xml", "<?xml version=\"1.0\" encoding=\"utf-8\" ?><items><item name=\"SiteTitle\" value=\"Your site title!\" /></items>");
		...
		{
			Assert.Throws<ArgumentNullException>(() => ExtensionsDataLoader.FileSystem = null);	
		}
		
		[Test]
		public void GetFilePath_NullsPassed_ArgumentNullExceptionsThrown()
		{
			var dl = new ExtensionsDataLoader("ExtensionsData", "C:/WebSites/FooSite", "en", "en");
		...
		{
			var dl = new ExtensionsDataLoader("ExtensionsData", "C:/WebSites/FooSite", "ru", "en");
		...
		{
			var dl = new ExtensionsDataLoader("ExtensionsData", "C:/WebSites/FooSite", "en", "ru");
