...
namespace AcspNet
{
	...
	public class AcspProcessor// : IAcspProcessor, IAcspProcessorContoller
	{
		...
		//internal AcspProcessor(IList<ExecExtensionMetaContainer> execExtensionMetaContainers, IList<LibExtensionMetaContainer> libExtensionMetaContainers, string currentAction, string currentMode)
		//{
